...
// import { Ihistoria } from 'src/app/interfaces/historia/historia';
...
export class CheckBoxComponent implements resourceData, OnInit {
  ...
  crearFormulario(): void {
    this.formularioHistorias.addControl(this.data.vr_name_dhd, this.formBuilder.control(false));
  }
  submit(){
