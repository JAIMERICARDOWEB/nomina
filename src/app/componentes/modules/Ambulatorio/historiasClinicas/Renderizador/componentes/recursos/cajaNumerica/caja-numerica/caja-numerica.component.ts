...
@Component({
  selector: 'app-caja-numerica',
  templateUrl: './caja-numerica.component.html',
  styleUrls: ['./caja-numerica.component.css']
})
export class CajaNumericaComponent implements resourceData, OnInit {
  ...
  crearFormulario(): void {
    this.formularioHistorias.addControl(this.data.vr_name_dhd, this.formBuilder.control(0));
  }
  submit(){
